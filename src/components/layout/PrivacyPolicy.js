...
const PrivacyPolicy = () => {
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      <h1>Privacy Policy for Mautamu</h1>

      <p>
        At mautamu.com, accessible from https://www.mautamu.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        mautamu.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in mautamu.com. This policy is not applicable to
      ...
      <p>
        mautamu.com follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, mautamu.com uses "cookies". These cookies are
      ...
      <p>
        ...
        advertising partners of mautamu.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on mautamu.com, which are sent
      ...
      <p>
        Note that mautamu.com has no access to or control over these cookies
      ...
      <p>
        mautamu.com's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        mautamu.com does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        not hesitate to contact us here info@mautamu.com.
      </p>
    </div>
  );
};
